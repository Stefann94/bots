      ...
      <section className="relative w-full h-[55vh] min-h-[400px] overflow-hidden flex pt-16 bg-grid-pattern radial-glow-top">
        ...
        <div className="relative z-10 w-full h-full flex flex-col md:flex-row">
          ...
          >
            ...
            <div className={`absolute inset-0 bg-[url('/images/hero_humanoid.png')] bg-cover bg-[center_top_40%] md:bg-[center_top_50%] transition-all duration-700 ease-in-out ${hoveredCategory === 'umanoizi' ? 'grayscale-0' : 'grayscale-[50%]'}`}></div>
          ...
          >
            {/* Background Image Specific */}
            <div className={`absolute inset-0 bg-[url('/images/hero_core.png')] bg-[length:auto_100%] md:bg-[length:auto_110%] bg-no-repeat bg-[center_top_20%] transition-all duration-700 ease-in-out ${hoveredCategory === 'patrupede' ? 'grayscale-0' : 'grayscale-[50%]'}`}></div>
            {/* Tint Overlay */}
          ...
          >
            {/* Background Image Specific */}
            <div className={`absolute inset-0 bg-[url('/images/hero_quadruped.png')] bg-[length:auto_100%] md:bg-[length:auto_110%] bg-no-repeat bg-center transition-all duration-700 ease-in-out ${hoveredCategory === 'ai' ? 'grayscale-0' : 'grayscale-[50%]'}`}></div>
            {/* Tint Overlay */}
