    ...
    <main className="text-white min-h-screen overflow-hidden selection:bg-cyber-cyan/30 bg-[#0f1f3d]">
      ...
      <section className="relative w-full h-[55vh] min-h-[400px] overflow-hidden flex pt-16 bg-grid-pattern radial-glow-top">
        ...
        <div className="relative z-10 w-full h-full flex flex-col md:flex-row">
          ...
          >
            {/* Background Image Specific */}
            <div className={`absolute inset-0 bg-[url('/images/ai_core_bg.png')] bg-cover bg-center transition-all duration-700 ease-in-out ${hoveredCategory === 'ai' ? 'grayscale-0' : 'grayscale-[50%]'}`}></div>
            {/* Tint Overlay */}
