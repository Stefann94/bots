                      ...
                      <div className="absolute top-4 left-4 right-4 z-20 flex justify-between items-center pointer-events-none">
                          ...
                          <div className="relative pointer-events-auto">
                              ...
                              <button 
                                ...
                                className="flex items-center gap-2 bg-navy-950/80 px-3 py-2.5 md:py-1.5 rounded border border-slate-700 hover:border-cyber-cyan transition-colors"
                              >
                              ...
                              {isColorMenuOpen && (
                                <div className="absolute right-0 top-full mt-2 w-60 md:w-48 bg-navy-950/95 border border-slate-700 rounded-lg p-3 shadow-xl backdrop-blur-md z-50 grid grid-cols-4 gap-3 animate-in fade-in zoom-in duration-200">
                                  {colors.map(c => (
                                    <button 
                                      key={c.value}
                                      onClick={() => { setRobotColor(c.value); setIsColorMenuOpen(false); }}
                                      className={`w-10 h-10 md:w-6 md:h-6 mx-auto rounded-full border-2 transition-all hover:scale-125 ${robotColor === c.value ? 'border-cyber-cyan scale-125 shadow-[0_0_12px_rgba(0,240,255,0.6)]' : 'border-slate-600'}`}
